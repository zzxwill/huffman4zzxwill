...
/**
 * ATESTZZX data access object (DAO) providing persistence and search support for User
...
public class UserDAO extends BaseHibernateDAO {
	...
	public User findById(java.lang.Integer id) {
		...
		try {
			User instance = (User) getSession().get("com.realestate.pojo.User",
					id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(User instance) {
		...
		try {
			List results = getSession().createCriteria(
					"com.realestate.pojo.User").add(Example.create(instance))
					.list();
